...
const AddProductAdmin = ({ getSidebar, sidebarData, createProduct, productDetail }) => {
	...
	const handleCreateProduct = (values) => {
		console.log(values);
		createProduct({ ...values, newPrice: parseInt(values.newPrice), oldPrice: parseInt(values.oldPrice) });
					...
					<div className='addProductAdmin__container container'>
						...
						<Formik
							initialValues={{
								...
								oldPrice: productDetail?.product?.oldPrice,
							}}
								...
								<Row gutter={[24, 16]}>
									...
									<Col xs={24}>
										<CustomField
											name='oldPrice'
											type='text'
											label={t('admin.products.oldPrice')}
											placeholder={t('admin.products.Enter unit price')}
											required
										/>
									</Col>
